...
- @context/masterstories/story-8-master-template.md (in-progress story — `@`-loaded for the duration of Milestone 12 per the convention below; remove at Story 8 / PR-B completion)
