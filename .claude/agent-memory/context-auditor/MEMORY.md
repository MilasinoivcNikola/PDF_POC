...
- [Catalog second-module lag](catalog-second-module-lag.md) — lib/catalog/ now 2 client-safe modules (+book-questions.ts) & sample-capture emits source-photo.jpg/sourcePhoto; CLAUDE.md+coding-standards catalog blurb lags (nice-to-have; playbook updated correctly)
- [Heart-glyph color canonical](heart-glyph-color-canonical.md) — HeartBookMark fill color is owned by its own comment, not a standing doc; prototype NOTES.md + history are frozen, don't flag them as drift
- [Hand-finished positioning canonical](hand-finished-positioning-canonical.md) — "hand-finished"=true human-gate (roadmap-owned, masterstory blurbs); "painted by hand"=false; AI-honesty stance now decided but roadmap:172 still says deferred (low-pri); prototypes frozen
