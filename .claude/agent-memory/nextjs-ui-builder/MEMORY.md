...
- [Catalog sampleImages: data vs disk](catalog-sample-images-data-vs-disk.md) — every product declares sampleImages paths but Story 8/9 files aren't on disk; `sampleImages[0] ?` placeholder fallbacks are dead → broken img, not paw
