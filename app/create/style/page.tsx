...
export default function StylePage() {
  ...
  const deathType = draft?.toggles.deathType ?? "natural";
  const beliefFrame = draft?.toggles.beliefFrame ?? "rainbow-bridge";
  const otherPetsInHome = draft?.toggles.otherPetsInHome ?? "no";
