...
import { isStory2Draft, isStory4Draft } from "@/lib/session/draft";
import type {
  GiftFor,
  LetterBeliefFrame,
  LetterDeathType,
...
export default function TonePage() {
  ...
  return isStory4 ? (
    <Story4Tone draft={draft} total={total} petLabel={petLabel} />
  ) : (
    <Story2Tone draft={draft} total={total} petLabel={petLabel} />
  );
}
