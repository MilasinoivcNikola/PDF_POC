...
// Story 2 · Step 3 of 6 — the owner the letter is addressed to: name(s) (required)
// and the relationship (single / couple), which drives the "you" vs "you both"
// letter voice. The owner names gate Continue (they are merged into every page of
// the letter). This route is Story-2 only — Story 1 uses /create/child here.
...
export default function OwnerPage() {
  ...
  return (
    <StepShell
      ...
      introAttribution="The one they would have written to, if they could."
      sectionLabel="Section · Three"
      sectionHeading={
        <>
          The one they <em>loved</em>.
        </>
      }
